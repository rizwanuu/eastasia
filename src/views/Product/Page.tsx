...
> = ({ add, product, items, queryAttributes, onAttributeChangeHandler }) => {
  ...
  return (
    <div className="product-page">
      ...
      <div className="container">
        <div className="product-page__product__feedback">
          <textarea placeholder="Write your comment Here..." className="product-page__product__textArea"></textarea>
          <button className="product-page__product__feedbackBtn">Leave a Feedback</button>
        </div>
      </div>
