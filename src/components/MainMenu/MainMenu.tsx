  ...
  return (
    ...
    >
          ...
          render={() => (
            <div className="main-menu__left">
              <Link href={paths.home}>
                <a>
                  <img style={{ width: "10rem" }} src={logoImg} />
                    ...
                    <>
                      {user ? (
                        ...
                        <>
                          ...
                          <li
                            data-test="desktopMenuLoginOverlayLink"
                            className="main-menu__register main-menu__signup"
                            onClick={() =>
                              overlayContext.show(
                                OverlayType.login,
                                OverlayTheme.right
      ...
      <div className="navbarPart2">
        <button className="categories" onClick={() => setShowCategory(!showCategory)}>
          Categories
        </button>
        {
          showCategory ?
        ...
        <input type="text" className="navbarPart2Input" placeholder="Search here" />
        <Online>
          <button
            data-test="menuCartOverlayLink"
            className="cartBtn"
